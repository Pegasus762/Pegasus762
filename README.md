...
<html>
	<head>
		<title>Brendan's Eportfolio</title>
		<meta charset="utf-8" />
	...
	<body class="is-preload">
		...
		<!-- Header -->
			<header id="header">
				<div class="inner">
					<a href="#" class="image pp"><img src="images/pp.jpg" width="295" height="210" alt="" /></a>
					<h1><strong>Brendan</strong> <br />
					<br /> Data Engineering UTM <br />
				</div>
			</header>
		...
		<!-- Main -->
			<div id="main">
				...
				<!-- One -->
					<section id="one">
						<header class="major">
							<h2>Hi, below are some resources for my Sem 1 Subjects</h2>
							<p>I hope it is beneficial for year 1 students!</p>
						</header>
				...
				<!-- Two -->
					<section id="two">
						<h2>2023/2024 Sem 1 Subjects</h2>
						<div class="row">
							<article class="col-6 col-12-xsmall work-item">
								<a href="images/thumbs/pogai.jpeg" class="image fit thumb"><img src="images/thumbs/pogai.jpeg" alt="" /></a>
								<h3>Programming Technique 1</h3>
								<a href="https://github.com/Pegasus762/Programming-Technique"target=_blank  >
									PT Past Year
									</a>
							</article>
							<article class="col-6 col-12-xsmall work-item">
								<a href="images/thumbs/dilo.jpeg" class="image fit thumb"><img src="images/thumbs/dilo.jpeg" alt="" /></a>
								<h3>Digital Logic</h3>
								<a href="https://github.com/Pegasus762/Digital-Logic"target=_blank  >
									Digital Logic Past Year
									</a>
							</article>
							<article class="col-6 col-12-xsmall work-item">
								<a href="images/thumbs/redo.jpeg" class="image fit thumb"><img src="images/thumbs/redo.jpeg" alt="" /></a>
								<h3>Discrete Structure</h3>
								<a href="https://github.com/Pegasus762/Discrete-Structure-Assignments"target=_blank  >
									DS Assigments
									</a>
							</article>
							<article class="col-6 col-12-xsmall work-item">
								<a href="images/thumbs/tis.jpeg" class="image fit thumb"><img src="images/thumbs/tis.jpeg" alt="" /></a>
								<h3>Technology Information and System</h3>
								<a href="https://github.com/Pegasus762/TIS-Assignment.git"target=_blank  >
								TIS Assignments	
								</a>
							
						</div>
						<ul class="actions">
							<li><a href="#" class="button" onclick="location.href='https://github.com/Pegasus762'  ">My Github</a></li>
						</ul>
					</section>
				...
				<!-- Three -->
					<section id="three">
						<h2>Get In Touch</h2>
						<p>Contact me for any further enquiries</p>
						<div class="row">
							...
							<div class="col-4 col-12-small">
								<ul class="labeled-icons">
									...
									<li>
										...
										<a href="#">yan04@graduate.utm.my</a>
									</li>
								</ul>
							</div>
						</div>
